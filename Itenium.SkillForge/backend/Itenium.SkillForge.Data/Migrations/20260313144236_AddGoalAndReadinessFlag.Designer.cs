...
namespace Itenium.SkillForge.Data.Migrations
{
    ...
    [Migration("20260313144236_AddGoalAndReadinessFlag")]
    partial class AddGoalAndReadinessFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.ReadinessFlagEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.ResourceCompletionEntity", b =>
                {
                    ...
                    b.HasIndex("ConsultantId", "ResourceId")
                        .IsUnique();
